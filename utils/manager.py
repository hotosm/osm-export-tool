...
aoi_geom = GEOSGeometry('SRID=4326;POLYGON((-17.4595135843873 14.7264073681691,-17.4595135843873 14.709736558776,-17.4393640190512 14.709736558776,-17.4393640190512 14.7264073681691,-17.4595135843873 14.7264073681691))')
...
#shp.run()
#theme_gpkg = ThematicGPKG(stage_dir+'geopackage.gpkg',feature_selection,per_theme=True)
#theme_gpkg.run()
