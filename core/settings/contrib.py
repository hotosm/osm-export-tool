...
SOCIAL_AUTH_OPENSTREETMAP_KEY = os.getenv('OSM_API_KEY', 'BkDwgJjmsIqjcuHmdwgSncHcGEuqpXuCw4EmQ7Go')
SOCIAL_AUTH_OPENSTREETMAP_SECRET = os.getenv('OSM_API_SECRET', '59AiFV5N0zuCqn2arYbRk97SsnzsesR8J438bXsQ')
