...
SOCIAL_AUTH_OPENSTREETMAP_KEY = os.getenv('OSM_API_KEY', '59AiFV5N0zuCqn2arYbRk97SsnzsesR8J438bXsQ')
SOCIAL_AUTH_OPENSTREETMAP_SECRET = os.getenv('OSM_API_SECRET', 'BkDwgJjmsIqjcuHmdwgSncHcGEuqpXuCw4EmQ7Go')
