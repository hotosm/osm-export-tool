...
OSMAND_MAP_CREATOR_DIR = os.getenv(
    "OSMAND_MAP_CREATOR_DIR", "/usr/local/OsmAndMapCreator"
)
...
TASKING_MANAGER_API_URL = os.getenv(
    "TASKING_MANAGER_API_URL",
    "https://tasking-manager-tm4-production-api.hotosm.org/api/v2/projects",
)


NOMINATIM_API_URL = os.getenv(
    "NOMINATIM_API_URL", "https://nominatim.openstreetmap.org/search.php"
)
