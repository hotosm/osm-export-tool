...
mv /tmp/cloudwatch_metrics.py /home/ubuntu/cloudwatch_metrics.py
chown ubuntu:ubuntu /home/ubuntu/cloudwatch_metrics.py
chmod +x /home/ubuntu/cloudwatch_metrics.py
