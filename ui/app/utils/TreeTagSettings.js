...
export const TAGLOOKUP = {
  Finance: {
    ...
    where:
      "amenity IN ('atm','bank','microfinance','mobile_money_agent','money_transfer')"
  },
  "Shops & Markets": {
    geom_types: ["point", "polygon"],
  ...
  "Drinking Water": {
    geom_types: ["point"],
    keys: ["name", "amenity", "pump", "man_made"],
    where: "amenity='water_point' or pump is not null or man_made='well'"
  },
  "Fire Hydrants and Defibrillators": {
    geom_types: ["point", "polygon"],
    keys: ["name", "emergency", "fire_hydrant:type"],
  ...
  Government: {
    ...
    where:
      "building='civic' OR amenity IN ('court_house','townhall') OR office='government' OR government IS NOT NULL"
  },
  Offices: {
    geom_types: ["point", "polygon"],
    keys: ["office", "name", "operator"],
  ...
  "Community Centres": {
    geom_types: ["point", "polygon"],
    keys: ["amenity", "community_centre", "name", "opening_hours"],
  ...
  "All Transit Stations": {
    geom_types: ["point", "polygon"],
    keys: ["name", "public_transport", "operator", "building", "amenity"],
  ...
  "Rail Stations": {
    geom_types: ["point", "polygon"],
    keys: ["name", "building", "railway", "public_transport", "operator"],
  ...
  "All Buildings": {
    geom_types: ["point", "polygon"],
    keys: ["building", "name", "building:levels"],
  ...
  "Water Supply Systems": {
    ...
    keys: ["man_made"],
    where:
      "man_made IN ('water_tower', 'pumping_station') OR building='pumping_station' OR landuse='reservoir' or waterway='floodgate'"
  },
  "Solid Waste": {
    geom_types: ["point", "polygon"],
    keys: ["name", "landuse"],
  ...
  "Bodies of Water": {
    geom_types: ["line", "polygon"],
    keys: ["water", "waterway", "natural"],
    where:
      "waterway IS NOT NULL OR water IS NOT NULL OR natural IN ('water','bay')"
  },
  Coastlines: {
    geom_types: ["line"],
    keys: ["natural"],
