...
import {setImportButtonSelected, setAllButtonsDefault, setImportModalState, processGeoJSONFile, resetGeoJSONFile} from '../../actions/aoi/mapToolActions';
        ...
        return (
            <PopupBox 
                ...
                <Dropzone onDrop={this.onDrop} 
                        ...
                        <span><strong>GeoJSON</strong> file in <strong>geographic coordinates (WGS84), 5 MB</strong> max,<br/>Drag and drop or<br/></span>
