...
class HDXExportRegionAdmin(admin.ModelAdmin, ExportCsvMixin):
    list_display = ['name','job_ui_link','schedule_period','last_run_hum','last_run_status','next_run','next_run_hum','last_export_size',"last_run_duration",'export_formats','schedule_hour','is_private','locations','edit_link']
